        ...
        <div className="row">
            ...
            <div className="numbers">
              <div className="row">
                ...
                <div className="col-sm-6">
                  <div className="item">
                    <h3>
                      <span className="nbr custom-font">6000</span>
                      <i>SQ M</i>
                    </h3>
                    <h6>WAREHOUSING</h6>
                  </div>
          ...
          <div className="col-lg-6">
            <div className="txt-cont">
              ...
              <p>
                Simply expert in Rattan especially &apos;Manau Skin On&apos; and
                have a lot of material to produce furniture not only for indoor
